(() => {
  ...
  module.exports = {
    rateLimiter: {
      rate_limit: 'Too Many Requests - your IP address is being rate limited'
    },
    roleAuthorize: {
    ...
    applicationMessage: {
      ...
      dbRestoreError: "Error occurred while restoring MongoDB backup file. Please Try again to restore the DB backup file",
    ...
    emailInvalid: {
      message: "Invalid email. Could not resolve the MX record of the email domain.",
        ...
        unauthorizedEmailDomain: "Unauthorized use of XcelTrip email domain"
    }
  };
