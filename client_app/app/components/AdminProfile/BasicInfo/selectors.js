...
const selectUpdateBasicInfo = (state) => state.adminProfileBasicInfo;
...
export { makeSelectSuccess, makeSelectResponse, makeSelectRequesting, makeSelectError, makeSelectUser };
