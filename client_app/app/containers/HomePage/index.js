      ...
      <Responsive minWidth={Responsive.onlyTablet.minWidth}>
        ...
        >
          ...
          >
            ...
            >
              <Container>
                <Menu.Item active><Icon name="home" /> Home</Menu.Item>
                <Menu.Item>Work</Menu.Item>
                <Menu.Item>Company</Menu.Item>
                <Menu.Item>Careers</Menu.Item>
                <Menu.Item position='right'>
                    <Link to="/login"> <Icon name="home" /> Login</Link>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        <Header as='h3' style={{ fontSize: '2em' }}>
          Establish in silicon valley.
        </Header>
        <p style={{ fontSize: '1.33em' }}>
          To lead the next generation digital transformation by 2025 serving
          global communities through collaborative and people-centric approach.
        </p>
        <Button size='large'>
          Read More
        </Button>
